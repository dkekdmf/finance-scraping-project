...
public class CompanyService {
    ...
    private Company storeCompanyAndDividend(String ticker){
        ...
        List<DividenedEntity> dviidendEntityList =  scrapedResult.getDividends().stream()
                .map(e -> new DividenedEntity(companyEntity.getId(),e))
                .collect((Collectors.toList()));

        this.dividendRepository.saveAll((dviidendEntityList));
        return company;
    }
    ...
    public String deleteCompany(String ticker){
        ...
        this.dividendRepository.deleteAllByCompnayId(company.getId());
